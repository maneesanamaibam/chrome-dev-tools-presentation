...
(function () {
  ...
  var lt =
    window.chrome && window.chrome.loadTimes && window.chrome.loadTimes();
  var timings = [];
  ...
  var navigationTypes = {};
  (navigationTypes[navigation.TYPE_NAVIGATENEXT || 0] =
    "Navigation started by clicking on a link, or entering the URL in the user agent's address bar, or form submission."),
    (navigationTypes[navigation.TYPE_RELOAD] =
      "Navigation through the reload operation or the location.reload() method."),
    (navigationTypes[navigation.TYPE_BACK_FORWARD] =
      "Navigation through a history traversal operation."),
    (navigationTypes[navigation.TYPE_UNDEFINED] =
      "Navigation type is undefined."),
  ...
  console.log(
    "Number of redirects that have taken place: ",
